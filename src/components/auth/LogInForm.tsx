...
import useLoginUserForm from "../../hooks/authHooks/useLogInForm";
import { Errors, LogIn } from "../../types/auth";
...
const LoginForm = ({ logInUser, errors }: FormProps) => {
  const [formState, dispatch] = useLoginUserForm();
    ...
    onSubmit={(e) => e.preventDefault()}>
      <div className="w-full space-y-2">
        ...
        <InputField
          ...
          error={formErrorsState.emailOrUsername}
      ...
      <button  className="mt-6 mb-3 bg-[#323b97] pt-2 pb-2 rounded-md text-[#F7EB2C] font-bold text-lg hover:bg-[#2a317d] duration-200"
